<%@ Page Title="Insurance" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Insurance.aspx.cs" Inherits="VehicleProject.Insurance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />       
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="False" Font-Size="Medium" ForeColor="Black" Text="Please Enter Licence Plate Number: " CssClass="auto-style5"></asp:Label>
            ...
            <tr>
                <td class="auto-style6">OR</td>
                <td class="auto-style13"></td>
                <td class="auto-style9"></td>
            </tr>
            <tr>
                <td class="auto-style6">
        <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="Medium" ForeColor="Black" Text="Please Enter Chassis Number: " Width="337px"></asp:Label>
                </td>
                <td class="auto-style13">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
            ...
            <EmptyDataTemplate>
                ALL VEHICLES INSURANCE ARE UP-TO-DATE
            </EmptyDataTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EC1_ID_GRPConnectionString %>" SelectCommand="SELECT [Chassis_Num], [Insurance_Date], [Make], [Model], [License_reg] FROM [VIEW_ALL_Vehicles] WHERE (([Chassis_Num] = @Chassis_Num) OR ([License_reg] = @License_reg) AND ([Insurance_Date] > @date)))">
                <SelectParameters>
                    <asp:SessionParameter Name="Chassis_Num" SessionField="ch" Type="String" />
                    <asp:SessionParameter Name="License_reg" SessionField="ln" Type="String"/>
